...
drop_modules=("mlp" "attn" "block" "consecutive_block")
drop_nums=("4" "8")


for model_name in "${model_names[@]}"
do
  # wget -P ./"$model_name"_model https://huggingface.co/meta-llama/Llama-2-13b-chat-hf/resolve/main/model-00001-of-00003.safetensors
  # wget -P ./"$model_name"_model https://huggingface.co/meta-llama/Llama-2-13b-chat-hf/resolve/main/model-00002-of-00003.safetensors
  # wget -P ./"$model_name"_model https://huggingface.co/meta-llama/Llama-2-13b-chat-hf/resolve/main/model-00003-of-00003.safetensors
