...
class MistralConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("drop_attn_list", drop_attn_list)
        print("drop_mlp_list", drop_mlp_list)
        ...
        print("self.drop_attn_list", self.drop_attn_list)
        print("self.drop_mlp_list", self.drop_mlp_list)
