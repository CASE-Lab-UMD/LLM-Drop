...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.drop_attn == False:
            ...
            pass
            #print(f"drop attn of {self.layer_idx}")
        if self.drop_mlp == False:
            # Fully Connected
            residual = hidden_states
            ...
            pass
            #print(f"drop mlp of {self.layer_idx}")
        outputs = (hidden_states,)

        if output_attentions:
            outputs += (self_attn_weights,) if self.drop_attn == False else (None,)

        if use_cache:
            outputs += (present_key_value,) if self.drop_attn == False else (None,)
