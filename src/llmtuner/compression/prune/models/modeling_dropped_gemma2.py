...
class Gemma2Attention(nn.Module):
    ...
    def __init__(self, config: Gemma2Config, layer_idx: Optional[int] = None, kv_cache_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Gemma2DecoderLayer(nn.Module):
    def __init__(self, config: Gemma2Config, layer_idx: int):
        ...
        if self.drop_attn:
            ...
            self.self_attn = GEMMA2_ATTENTION_CLASSES[config._attn_implementation](config=config, layer_idx=layer_idx, kv_cache_idx=self.kv_cache_idx)
